...
subtitle: "Replication of Lima-Lopes (2020) - Part 2"
...
library(ggradar)
library(scales)
load("/Volumes/GoogleDrive/My Drive/Profissional/Pedagogico/UNICAMP/disciplinas/pos/R/lp192_2021/rep_mod_3.RData")
```
...
```{r lemmatise, eval = FALSE, echo = TRUE}
...
```{r exporting, eval = FALSE, echo = TRUE}
#as a matrix
...
```{r plotting2, eval = FALSE, echo = TRUE}
