...
Unfortunately, it is not possible to replicate @lima-lopes2020c entirely due to the fact that some of the pieces of news which were the base for the paper are not available at the newspapers' websites or cannot be scraped due to pay wall restrictions. To cope with this problem, I kept an index with the same number of pieces news, but the results will look a bit different. 
